...
By default installation, it will generate a new folder, namely **intel**, under your home directory. It is recommended to move it to a specific folder to store all the compilers. Here is my example:
